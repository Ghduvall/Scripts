...
#region ***Parameters***  
$SiteURL="https://allanedwardstulsa.sharepoint.com/sites/QualityControl"  
$ReportFile="C:\Users\GrantDuvall\OneDrive - NSN Management, LLC\Desktop\FolderPermissionRptaa.csv"  
$FolderRelativeURL = "/sites/QualityControl/Shared Documents/Test Files"  
#endregion  
